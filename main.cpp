...
void DrawGLScene()
{
  ...
  rtri+=0.0003f;                    // Increase The Rotation Variable For The Triangle
  if(rtri>2)
      rtri=-2.0f;
  rquad-=0.05f;                    // Decrease The Rotation Variable For The Quad
...
int main(int argc, char **argv)
{
  ...
  /* Open a window */
  window = glutCreateWindow("Moving 2D Car");
